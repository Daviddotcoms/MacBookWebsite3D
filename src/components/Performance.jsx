    ...
    <section id="performance" ref={sectionRef}>
      ...
      <div className="wrapper">
        {performanceImages.map(({ id, src, alt }) => (
          <img key={id} className={id} src={src} alt={alt} />
        ))}
      </div>
      ...
      <div className="content">
        <p>
          ...
          with your imaginaation. The M4 family of chips features a GPU with a
          ...
          increase average GPU utilization -- driving a huge performance boos
